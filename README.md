...
#### 3. 目前测试过的Qt版本:
|操作系统|Qt版本|编译器|位数|支持情况
|---|---|---|---|---
|Win7<br>Win10|5.7.0|MSVC2013<br>MSVC2015|32位<br>64位|支持
...
| | | | |
|Android|5.7.0<br>5.9.0<br>5.12.0|ndk-r15c|32位|计划中
|IOS|5.7.0<br>5.9.0<br>5.12.0|clang|32位<br>64位|计划中
